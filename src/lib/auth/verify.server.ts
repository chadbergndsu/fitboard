...
import { PORTAL_COOKIE, verifyPortalToken } from "./simple-portal";
 ...
 */
function portalUserFromRequest(request: Request): VerifiedUser | null {
...
export async function getSessionUser(
  ...
  // Simple portal password session (works without Postgres on Vercel)
  const portal = portalUserFromRequest(request);
...
export async function requireUserId(bearerToken?: string): Promise<string> {
  // Always accept simple portal cookie when present
